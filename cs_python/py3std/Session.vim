...
nmap , <Plug>Sneak_,
noremap / :set hls/
nnoremap ;qf :call QuickfixToggle()
nnoremap ;,e 60|
vnoremap ;" :'<I":'>I"
nnoremap ;" viwa"hbi"lel
nnoremap ;sm :source ~/.vim/after/plugin/keymapper.vim
nnoremap ;em :vsplit ~/.vim/after/plugin/keymapper.vim
nnoremap ;sv :source $MYVIMRC
nnoremap ;ev :vsplit $MYVIMRC
map ;; <Plug>(easymotion-prefix)
nnoremap ;tb :TagbarToggle
nnoremap ;tlsl :TlistSessionLoad ~/.vim/tmp/tlist.session
nnoremap ;tls :TlistSessionSave ~/.vim/tmp/tlist.session
nnoremap ;tllu :TlistUnlock
nnoremap ;tll :TlistLock
nnoremap ;tlu :TlistUpdate
...
iabbr xyy xyy15926
iabbr @2 xyy15926@gmail.com
iabbr @1 xyy15926@163.com
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set background=dark
...
set ruler
set runtimepath=~/.vim,~/.vim/bundles/nerdtree/,~/.vim/bundles/tagbar/,~/.vim/bundles/vim-airline/,~/.vim/bundles/vim-easymotion/,~/.vim/bundles/vim-surround/,~/.vim/bundles/vim-commentary/,~/.vim/bundles/delimitMate/,~/.vim/bundles/vim-sneak/,~/.vim/bundles/vim-jsx/,~/.vim/bundles/vim-javascript/,~/.vim/bundles/html5.vim/,~/.vim/bundles/xml.vim/,/usr/share/vim/site,~/.vim/runtime,/usr/share/vim/site/after,~/.vim/bundles/vim-jsx/after,~/.vim/bundles/vim-javascript/after,~/.vim/bundles/html5.vim/after,~/.vim/after
set scrolloff=5
set shiftwidth=4
set showmatch
set smartcase
...
silent only
cd /mnt/c/Users/xyy15926/Code/proxy/cs_python/py3std
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +144 mdl_pkgs.md
badd +135 cls_templates.md
badd +13 metaclass.md
badd +1423 parallel.md
badd +59 cls_herit.md
badd +0 cls_metaattrs.md
argglobal
silent! argdel *
$argadd mdl_pkgs.md
set stal=2
...
nnoremap <buffer> ,pt :?^##\+
nnoremap <buffer> ,nt :/^##\+
nnoremap <buffer> ,lt :ilist /^#\{1,6\}[ \t]\+
nnoremap <buffer> ,cc ^hi-lli`f：i`
nnoremap <buffer> <silent> [" :call search('\%(^\s*<!--.*\n\)\%(^\s*-->\)\@!', 'bW')
nnoremap <buffer> <silent> ]" :call search('^\(\s*<!--.*\n\)\@<!\(\s*-->\)', 'W')
onoremap <buffer> ah :execute "normal! ?^==\\+$\r:nohlsearch\rg_vk0"
onoremap <buffer> ih :execute"normal! ?^==\\+$\r:nohlsearch\rkvg_"
...
imap <buffer> ( <Plug>delimitMate(
imap <buffer> ) <Plug>delimitMate)
inoremap <buffer> ,xi $\mathcal{}$hi
inoremap <buffer> ,xar \begin{array}{l}\end{array}O
inoremap <buffer> ,xal \begin{align*}\end{align*}O
inoremap <buffer> ,xm $$\mathcal{}$$O
inoremap <buffer> ,cb ```"=b:langpo```O
imap <buffer> [ <Plug>delimitMate[
imap <buffer> ] <Plug>delimitMate]
imap <buffer> ` <Plug>delimitMate`
imap <buffer> { <Plug>delimitMate{
...
let s:l = 8 - ((5 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
8
normal! 0
tabedit cls_herit.md
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 57 - ((19 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
normal! 0
tabedit cls_metaattrs.md
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
370
normal! zo
let s:l = 274 - ((17 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
274
